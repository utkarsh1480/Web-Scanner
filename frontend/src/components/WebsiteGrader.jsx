              ...
              <div className="card max-w-xl">
                ...
                <div className="mt-8 border-t border-border/50 pt-6">
                  <p className="text-sm text-muted-foreground mb-4 text-center font-medium">
                    Want a deeper analysis? Scan your source code directly.
                  </p>
                  <Link 
                    to="/github/dashboard" 
                    className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#24292e] hover:bg-[#2c3137] text-white rounded-lg transition-colors font-medium shadow-md"
                  >
