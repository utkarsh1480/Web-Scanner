        ...
        <div className="gs-nav-main">
          <div className="gs-nav-main-left">
            ...
            <div className="hidden md:flex items-center">
              <Link to="/" className="gs-nav-item">{t.navHome}</Link>
              <Link to="/lighthouse" className="gs-nav-item">{t.navLighthouse}</Link>
          ...
          <div className="gs-nav-main-right">
            ...
            {user ? (
              ...
              <div className="hidden md:flex items-center gap-2">
                <Link to="/login" className="gs-btn-signin">{t.navSignIn}</Link>
                <Link to="/register" className="gs-btn-start">{t.navStartFree}</Link>
              </div>
            )}
